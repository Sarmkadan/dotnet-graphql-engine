...
sealed public class GraphQLEngineOptions
{
    ...
    /// <returns>A new GraphQLEngineOptions instance with values from legacy configuration</returns>
    /// <remarks>
    ...
    ///
    /// New applications should use the typed options pattern instead.
    /// </remarks>
    public static GraphQLEngineOptions BindFromLegacyConfiguration(IConfiguration configuration)
    {
        ...
        Console.Error.WriteLine("[DEPRECATION WARNING] Legacy string-based configuration keys are deprecated. " +
                            "Use the typed GraphQLEngineOptions pattern instead.");
